 ...
 * BIOTECH_CONFIG_FILE environment variable. config.example.php is the
 * committed template - copy it to config.php and fill in real values.
 */

set_exception_handler(function (Throwable $exception): void {
    error_log('[civitas-biotech-bridge] ' . $exception->getMessage());
...
$configFile = getenv('BIOTECH_CONFIG_FILE') ?: '';
$config = null;
