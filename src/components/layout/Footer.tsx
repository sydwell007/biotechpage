    ...
    <footer className="siteFooter">
      <div className="container">
        <div className="footerLead">
          <div>
            <span className="eyebrow">Build the platform</span>
            <h2>Human capability has an operating system now.</h2>
          </div>
          <div className="footerLeadActions">
            <ButtonLink href={primaryCtas.investors.href} variant="accent">
              Investor Thesis
            </ButtonLink>
        ...
        <div className="footGrid">
          <div className="footerBrand">
            <Brand tagline="Neural Interfaces. Wearable Robotics. NeuroOS." />
        ...
        <div className="footerBottom">
          <p className="small copyright">© {year} Civitas BioTech. All rights reserved.</p>
          <p className="small">Neural Interfaces • Wearable Robotics • NeuroOS</p>
        </div>
      </div>
    </footer>
  );
