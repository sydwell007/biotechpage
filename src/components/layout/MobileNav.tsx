        ...
        <>
          ...
          >
            <div className="mobileNavIntro">
              <span>Civitas BioTech</span>
              <p>Neural interfaces, wearable robotics and NeuroOS.</p>
            </div>
            ...
            <div className="mobileNavCtas">
              <Link href={primaryCtas.partner.href} className="btn primary" onClick={close}>
                Partner With Us
              </Link>
              <Link href={primaryCtas.investors.href} className="btn" onClick={close}>
                Investors
              </Link>
            </div>
          </div>
