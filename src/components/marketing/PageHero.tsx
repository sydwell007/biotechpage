        ...
        <div className="innerHeroCard">
          ...
          <div className="pageHeroGrid">
            ...
            <div className="pageHeroVisual" aria-hidden="true">
              ...
              <span className="visualCore">CB</span>
              <span className="visualLabel visualLabelOne">Signal</span>
              <span className="visualLabel visualLabelTwo">Intent</span>
              <span className="visualLabel visualLabelThree">Action</span>
            </div>
          </div>
